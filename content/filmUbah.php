...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    //                 <a href="filmUbah.php" class="btn btn-danger" >Kembali</a>
    //             </div>
    //         </div>
    //         HTML;
    //     exit;
    ...
    $hasilnya = $koneksinya->query("UPDATE film set 
    judulFilm   = '$judul',
    genreFilm   = '$genre',
    durasiFilm  = '$durasi',
    sutradara   = '$sutradara'
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row mb-4">
                <div class="col-6 mt-3">
                    ...
                    <input type="text" class="form-control" name="judulFilm" placeholder="Masukan Judul" value="<?= $judul; ?>">
                </div>
                <div class="col-6 mt-3">
                    <label class=" ml-2" for="genreFilm">Genre Film</label>
                    <input type="text" class="form-control" name="genreFilm" placeholder="Masukan Genre" value="<?= $genre; ?>">
                </div>
                <div class="col-6 mt-3">
                    <label class=" ml-2" for="durasiFilm">Durasi Film</label>
                    <input type="text" class="form-control" name="durasiFilm" placeholder="Masukan Durasi" value="<?= $durasi ?>">
                </div>
                <div class="col-6 mt-3">
                    <label class=" ml-2" for="sutradara">Sutradara</label>
                    <input type="text" class="form-control" name="sutradara" placeholder="Masukan Nama Sutradara" value="<?= $sutradara ?>">
                </div>
                <!-- <div class="col-6 mt-3">
